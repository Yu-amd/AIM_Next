...
Complete model fine-tuning without LoRA adapters.
"""
...
class FullTrainer(BaseTrainer):
    """Full fine-tuning trainer (no LoRA, all parameters trainable)."""
    ...
    def prepare_model_for_training(self) -> None:
        """Prepare model for training (enable gradient checkpointing if needed)."""
