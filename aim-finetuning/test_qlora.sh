#!/bin/bash
# Test script for QLoRA fine-tuning trainer

set -e

echo "=== AIM Fine-Tuning - QLoRA Trainer Test ==="
echo ""
...
python3 -c "import bitsandbytes; print(f'BitsAndBytes: {bitsandbytes.__version__}')" || { echo "Error: BitsAndBytes not installed. Install with: pip install bitsandbytes"; exit 1; }
...
# Run training
echo "Starting QLoRA fine-tuning test..."
echo ""
